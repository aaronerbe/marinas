...
export default class WebCams {
    ...
    */
    ...
    buildBaseURL() {
        return `https://api.windy.com/webcams/api/v3/webcams?offset=0&categoryOperation=or&nearby=${this.lat}%2C${this.lon}%2C50&include=categories,images,location,player,urls&categories=water,island,beach,harbor,bay,coast,underwater`;
    }
}